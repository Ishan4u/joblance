  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8">
          <!-- Fetch job details -->
          <?php 
          $select_job = $conn->prepare("SELECT u_p.*,p.*,c.* FROM user_post u_p INNER JOIN post p ON u_p.job_id = p.job_id INNER JOIN company c ON p.com_id = c.com_id WHERE u_id=? AND u_p.status = 1");
